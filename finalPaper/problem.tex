We apply this proposed methodology to an Electric Vehicle (EV) battery dissasembly task. Within this environment, a Unitree H1-2 Robot \comment{cite} and UR16e Robotic arm \comment{cite} are tasked with removing the protective cover from an EV battery.
