We apply this proposed methodology to an Electric Vehicle (EV) battery dissasembly task. Within this environment, a H-1 Unitree Robot \comment{cite} and UR16e Robotic arm \comment{cite} are tasked with removing the protective cover from an EV battery.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{humanoid_and_battery.png}
    \caption{An H1-Unitree and UR16e positioned to collaborate on removing  bolts from an EV battery protective cover.}
    \label{fig:workspace}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        ...
        \caption{Behavior Tree for the H12-Unitree humanoid robot.}
