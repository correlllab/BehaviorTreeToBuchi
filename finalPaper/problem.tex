We apply this proposed methodology to an Electric Vehicle (EV) battery dissasembly task. Within this environment, a Unitree H1-2 Robot~\citep{unitree_h1} and UR16e Robotic arm~\citep{ur16e} are tasked with removing the protective cover from an EV battery.
