...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \caption{Original Behavior Tree for the H12-Unitree humanoid robot.}
        \label{fig:BT_arm}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \caption{Fixed Behavior Tree for the H12-Unitree humanoid robot.}
